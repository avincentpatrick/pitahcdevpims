...
function generateChart() {
  ...
  function updateChartA() {
      async function fetchData() {    
        ...
        const set_url = 'http://192.168.1.250/pitahcdevpims/api/respondents_sex/'+year+'/';
    ...
    function generateChartA() {
      async function fetchData() {    
        ...
        const app_url = '{{ env('APP_URL') }}';
        const url = 'http://192.168.1.250/pitahcdevpims/api/respondents_sex_filter/'+year+'/'+report_type_id;
  ...
  plugins: [ChartDataLabels]
    ...
    function updateChartB() {
      async function fetchData() {  
        ...
        const year = segments[segments.length - 1];
        const app_url = '{{ env('APP_URL') }}';
        const set_url = 'http://192.168.1.250/pitahcdevpims/api/respondents_client_type/'+year+'/';
        const response = await fetch(set_url);
        const datapoints = await response.json();
        return datapoints;
      };
    ...
    function generateChartB() {
      async function fetchData() {    
        ...
        const report_type_id = document.getElementById("report_type_id");
        const app_url = '{{ env('APP_URL') }}';
        const url = 'http://192.168.1.250/pitahcdevpims/api/respondents_client_type_filter/'+year+'/'+report_type_id;
        const response = await fetch(url);
        const datapoints = await response.json();
        return datapoints;
      };
  ...
  plugins: [ChartDataLabels]
    ...
    function updateChartC() {
      async function fetchData() {  
        ...
        const year = segments[segments.length - 1];
        const app_url = '{{ env('APP_URL') }}';
        const set_url = 'http://192.168.1.250/pitahcdevpims/api/respondents_transacting_office/'+year+'/';
        const response = await fetch(set_url);
        const datapoints = await response.json();
        return datapoints;
      };
    ...
    function generateChartC() {
      async function fetchData() {    
        ...
        const report_type_id = document.getElementById("report_type_id");
        const app_url = '{{ env('APP_URL') }}';
        const url = 'http://192.168.1.250/pitahcdevpims/api/respondents_transacting_office_filter/'+year+'/'+report_type_id;
        const response = await fetch(url);
        const datapoints = await response.json();
        return datapoints;
      };
  ...
  plugins: [ChartDataLabels]
    ...
    function updateChartD() {
      async function fetchData() {  
        ...
        const year = segments[segments.length - 1];
        const app_url = '{{ env('APP_URL') }}';
        const set_url = 'http://192.168.1.250/pitahcdevpims/api/ratings/'+year+'/';
        const response = await fetch(set_url);
        const datapoints = await response.json();
        return datapoints;
      };
    ...
    function generateChartD() {
      async function fetchData() {   
        ...
        const report_type_id = document.getElementById("report_type_id");
        const app_url = '{{ env('APP_URL') }}';
        const url = 'http://192.168.1.250/pitahcdevpims/api/ratings/'+year+'/'+report_type_id;
        const response = await fetch(url);
        const datapoints = await response.json();
        return datapoints;
      };
  ...
  plugins: [ChartDataLabels]
    ...
    function updateChartE() {
      async function fetchData() {  
        ...
        const year = segments[segments.length - 1];
        const app_url = '{{ env('APP_URL') }}';
        const set_url = 'http://192.168.1.250/pitahcdevpims/api/average/'+year+'/';
        const response = await fetch(set_url);
        const datapoints = await response.json();
        return datapoints;
      };
    ...
    function generateChartE() {
      async function fetchData() {    
        ...
        const report_type_id = document.getElementById("report_type_id");
        const app_url = '{{ env('APP_URL') }}';
        const url = 'http://192.168.1.250/pitahcdevpims/api/average/'+year+'/'+report_type_id;
        const response = await fetch(url);
        const datapoints = await response.json();
        return datapoints;
      };
  ...
  plugins: [ChartDataLabels]
    ...
    function updateChartF() {
      async function fetchData() {  
        ...
        const year = segments[segments.length - 1];
        const app_url = '{{ env('APP_URL') }}';
        const set_url = 'http://192.168.1.250/pitahcdevpims/api/respondents_availed_service/'+year+'/';
        const response = await fetch(set_url);
        const datapoints = await response.json();
        return datapoints;
      };
    ...
    function generateChartF() {
      async function fetchData() {    
        ...
        const report_type_id = document.getElementById("report_type_id");
        const app_url = '{{ env('APP_URL') }}';
        const url = 'http://192.168.1.250/pitahcdevpims/api/respondents_availed_service_filter/'+year+'/'+report_type_id;
        const response = await fetch(url);
        const datapoints = await response.json();
        return datapoints;
      };
...
const configF = {
  ...
  async function fetchData() {  
    ...
    const year = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = 'http://192.168.1.250/pitahcdevpims/api/respondents_client_group/'+year+'/';
    const response = await fetch(set_url);
    const datapoints = await response.json();
    return datapoints;
  };
...
function updateChartH() {
  async function fetchData() {  
    ...
    const year = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = 'http://192.168.1.250/pitahcdevpims/api/respondents_region/'+year+'/';
    const response = await fetch(set_url);
    const datapoints = await response.json();
    return datapoints;
  };
...
function updateChartI() {
  async function fetchData() {  
    ...
    const year = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = 'http://192.168.1.250/pitahcdevpims/api/respondents_awareness_response/'+year+'/';
    const response = await fetch(set_url);
    const datapoints = await response.json();
    return datapoints;
  };
...
function updateChartJ() {
  async function fetchData() {  
    ...
    const year = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = 'http://192.168.1.250/pitahcdevpims/api/respondents_visibility_response/'+year+'/';
    const response = await fetch(set_url);
    const datapoints = await response.json();
    return datapoints;
  };
...
function updateChartK() {
  async function fetchData() {  
    ...
    const year = segments[segments.length - 1];
    const app_url = '{{ env('APP_URL') }}';
    const set_url = 'http://192.168.1.250/pitahcdevpims/api/respondents_helpfulness_response/'+year+'/';
    const response = await fetch(set_url);
    const datapoints = await response.json();
    return datapoints;
  };
